...
import (
	...
	tuicfg "github.com/comgunner/picoclaw/cmd/picoclaw-launcher-tui/config"
	"github.com/comgunner/picoclaw/cmd/picoclaw-launcher-tui/ui"
)
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "picoclaw-agents-launcher-tui: %v\n", err)
		os.Exit(1)
	}
