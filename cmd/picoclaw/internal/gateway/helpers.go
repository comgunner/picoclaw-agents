...
import (
	...
	"github.com/comgunner/picoclaw/pkg/cron"
	"github.com/comgunner/picoclaw/pkg/devices"
	"github.com/comgunner/picoclaw/pkg/health"
	"github.com/comgunner/picoclaw/pkg/heartbeat"
...
func gatewayCmd(debug bool) error {
	...
	// Initialize sentinel callbacks for auto-reactivation notifications
	agentLoop.InitSentinelCallbacks()
	...
	if err != nil {
		return fmt.Errorf("error setting up cron tool: %w", err)
	}
