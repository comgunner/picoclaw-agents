...
> [!IMPORTANT]
> **PicoClaw Developer Guidelines**: All agent planning, task logs, and architectural notes must be kept in the `local_work/` directory. This directory is ignored by Git to ensure personal workspace status and prevent repository contamination.
## Getting Started
...
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/comgunner/picoclaw.git
   ```
