#!/bin/bash
# Build macOS .app bundle for PicoClaw-Agents Launcher
...
if [ -f "./build/picoclaw-agents" ]; then
    cp "./build/picoclaw-agents" "${APP_MACOS}/"
else
    echo "Error: ./build/picoclaw-agents not found. Please build the main file first."
    echo "Run: make build"
    exit 1
fi
chmod +x "${APP_MACOS}/"*
...
<dict>
    ...
    <string>picoclaw-agents-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.picoclaw-agents.launcher</string>
...
echo "=========================================="
echo ""
echo "To launch PicoClaw-Agents:"
