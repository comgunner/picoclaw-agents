...
* **Audience Strategy**: Third-party data segments, contextual targeting, first-party audience activation on display, lookalike[PATH_REMOVED] audience building, retargeting window optimization
* **Creative Formats**: Standard IAB sizes, native ad formats, rich media, video pre-roll[PATH_REMOVED], CTV[PATH_REMOVED] ad specs, responsive display ad optimization
* **Brand Safety**: Brand safety verification, invalid traffic (IVT) monitoring, viewability standards (MRC, GroupM), blocklist[PATH_REMOVED] management, contextual exclusions
...
* CTV[PATH_REMOVED] buying strategy for reach extension beyond digital display
