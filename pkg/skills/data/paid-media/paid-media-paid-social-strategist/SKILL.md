...
* **Creative Strategy**: Platform-native creative requirements, UGC-style content for TikTok[PATH_REMOVED], professional content for LinkedIn, creative testing at scale, dynamic creative optimization
...
* Creative fatigue detection and automated refre[BASH_SCRIPT_REMOVED]
...
* **Thumb-Stop Rate**: 25%+ 3-second video view rate on Meta[PATH_REMOVED]
