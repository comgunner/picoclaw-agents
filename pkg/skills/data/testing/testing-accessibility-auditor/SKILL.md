...
## 📋 Audit Overview
**Product[PATH_REMOVED]**: [Name and scope of what was audited]
...
**Screen Reader Testing**: [VoiceOver[PATH_REMOVED] — OS and browser versions]
**Keyboard Testing**: [All interactive flows tested keyboard-only]
**Visual Testing**: [Zoom 200%[PATH_REMOVED]%, high contrast, reduced motion]
...
**WCAG Criterion**: [Number — Name] (Level A[PATH_REMOVED])
...
### Immediate (Critical[PATH_REMOVED] — fix before release)
...
**Modals[PATH_REMOVED]**: [Focus trapped? Escape closes? Focus returns on close?]
...
**Toast[PATH_REMOVED]**: [Announced via aria-live? Dismissible?]

## Findings
| Component | Screen Reader Behavior | Expected Behavior | Status |
|-----------|----------------------|-------------------|--------|
| [Name]    | [What was announced] | [What should be]  | PASS[PATH_REMOVED] |
```
...
- [ ] Focus returns to trigger element after modal[PATH_REMOVED] closes

## Component-Specific Patterns
### Tabs
- [ ] Tab key moves focus into[PATH_REMOVED] of the tablist and into the active tabpanel content
- [ ] Arrow keys move between tab buttons
- [ ] Home[PATH_REMOVED] move to first[PATH_REMOVED] tab
- [ ] Selected tab indicated via aria-selected

### Menus
- [ ] Arrow keys navigate menu items
- [ ] Enter[PATH_REMOVED] activates menu item
- [ ] Escape closes menu and returns focus to trigger

### Carousels[PATH_REMOVED]
- [ ] Arrow keys move between slides
- [ ] Pause[PATH_REMOVED] control available and keyboard accessible
...
```[BASH_SCRIPT_REMOVED]
npx @axe-core[PATH_REMOVED] http:[PATH_REMOVED]:8000 --tags wcag2a,wcag2aa,wcag22aa

# Run Lighthouse accessibility audit
npx lighthouse http:[PATH_REMOVED]:8000 --only-categories=accessibility --output=json
...
### Testing Integration
- Integrate axe-core into CI[PATH_REMOVED] pipelines for automated regression testing
