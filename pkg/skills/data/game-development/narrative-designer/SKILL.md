...
description: [PATHREMOVED] Scene: First meeting with Commander Reyes
...
- Every dialogue node must have a clear dramatic function: reveal, establi[BASH_SCRIPT_REMOVED]
...
- No contradictions between environmental storytelling and dialogue[PATH_REMOVED] story
...
```
[PATH_REMOVED] Scene: First meeting with Commander Reyes
[PATH_REMOVED] Tone: Tense, power imbalance, protagonist is being evaluated
...
### Voice Pillars
- **Vocabulary**: [Formal[PATH_REMOVED], technical[PATH_REMOVED], regional flavor]
- **Sentence Rhythm**: [Short[PATH_REMOVED] for urgency | Long[PATH_REMOVED] for thoughtfulness]
...
```markdown
## Environmental Story Beat: [Room[PATH_REMOVED] Name]
...
- [Disturbance[PATH_REMOVED]]: [What suggests recent events?]
...
- Write dialogue in engine-ready format (Ink[PATH_REMOVED]) from day one — no screenplay middleman
