---
name: game-designer
description: Variable          | Base Value | Min | Max | Tuning Notes
...
- Balance economies, progression curves, and risk[PATH_REMOVED] systems with data
...
- **Feedback**: Immediate [visual[PATH_REMOVED]] response
- **Reward**: [Resource[PATH_REMOVED] satisfaction]

## Session Loop (5–30 minutes)
- **Goal**: Complete [objective] to unlock [reward]
- **Tension**: [Risk or resource pressure]
- **Resolution**: [Win[PATH_REMOVED] state and consequence]
...
**Player Fantasy**: What power[PATH_REMOVED] this delivers
...
**Edge Cases**:
  ...
  - What if the player has [max[PATH_REMOVED]] resource?
**Tuning Levers**: [List of variables that control feel[PATH_REMOVED]]
...
- Model player economies as supply[PATH_REMOVED] systems: plot sources, sinks, and equilibrium curves
