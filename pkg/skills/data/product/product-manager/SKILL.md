...
description: What specific user pain or business opportunity are we solving?
category: product
version: 1.0.0
---
...
| Reduce support load | Tickets[PATH_REMOVED] on this topic | 120 | <40 | 90 days post-launch |
...
**Dependencies**:
- [System / team / API] — needed for [reason] — owner: [name] — timeline risk: [High[PATH_REMOVED]]
...
| Closed beta | [date] | 50 opted-in customers | <5% error rate, CSAT ≥ 4[PATH_REMOVED] |
...
## 2. User Evidence
**Interviews** (n=X):
- Key theme 1: "[representative quote]" — observed in X[PATH_REMOVED] sessions
- Key theme 2: "[representative quote]" — observed in X[PATH_REMOVED] sessions
...
**Support Signal**:
- X tickets[PATH_REMOVED] containing [theme] — [% of total volume]
...
- **Market sizing**: [TAM[PATH_REMOVED] context relevant to this feature space]
...
| Factor | Value | Notes |
|--------|-------|-------|
| Reach | [X users[PATH_REMOVED]] | Source: [analytics / estimate] |
| Impact | [0.25 / 0.5 / 1 / 2 / 3] | [justification] |
| Confidence | [X%] | Based on: [interviews / data / analogous features] |
| Effort | [X person-months] | Engineering t-shirt: [S[PATH_REMOVED]] |
...
**One-liner**: [Feature] helps [persona] [achieve specific outcome] without [current pain[PATH_REMOVED]].
...
- [ ] Social copy ready (LinkedIn, Twitter[PATH_REMOVED])
...
- Define the rollout strategy: feature flags, phased cohorts, A[PATH_REMOVED] experiment, or full release
...
- **Launch readiness**: 100% of GA launches ship with trained CS[PATH_REMOVED] team, published help documentation, and GTM assets complete
