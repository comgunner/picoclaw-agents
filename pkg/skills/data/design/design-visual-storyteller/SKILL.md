...
description: ls public[PATHREMOVED]
category: design
version: 1.0.0
---
...
- **Character Development**: Protagonist identification (often customer[PATH_REMOVED])
- **Conflict Identification**: Problem or challenge driving the narrative
- **Resolution Design**: How brand[PATH_REMOVED] provides the solution
...
ls public[PATH_REMOVED]
grep -i "story\|narrative\|message" ai[PATH_REMOVED]*.md
```
