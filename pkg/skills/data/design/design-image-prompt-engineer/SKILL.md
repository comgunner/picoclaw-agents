...
description: [Subject description with age, ethnicity, expression, attire] |
category: design
version: 1.0.0
---
...
- Use correct photography terminology (not "blurry background" but "shallow depth of field, f[PATH_REMOVED] bokeh")
...
- **Light Quality**: Hard[PATH_REMOVED], diffused, specular, volumetric, dramatic
...
- **Era[PATH_REMOVED] Style**: Vintage, contemporary, retro, futuristic, timeless
...
[Camera: 85mm lens, f[PATH_REMOVED], eye-level] |
[Style: editorial[PATH_REMOVED]] |
...
[Surface[PATH_REMOVED] description] |
[Lighting: softbox positions, reflectors, gradients] |
[Camera: macro[PATH_REMOVED], angle, distance] |
[Hero shot[PATH_REMOVED] context] |
[Brand aesthetic alignment] |
[Post-processing: clean[PATH_REMOVED]]
```
...
[Color palette: natural[PATH_REMOVED]] |
[Style: documentary[PATH_REMOVED] art[PATH_REMOVED]]
```
...
[Location[PATH_REMOVED] design] |
[Pose: editorial[PATH_REMOVED]] |
[Lighting: dramatic[PATH_REMOVED]] |
[Camera movement suggestion: static[PATH_REMOVED]] |
[Magazine[PATH_REMOVED] aesthetic reference]
```
...
- Generated images are suitable for professional[PATH_REMOVED] use
...
### Cinematic Portrait
```
Dramatic portrait of [subject], [age[PATH_REMOVED]], wearing [attire],
[expression[PATH_REMOVED]], photographed with cinematic lighting setup:
...
shot on 85mm f[PATH_REMOVED] lens at eye level, shallow depth of field with
...
### Luxury Product
```
[Product name] hero shot, [material[PATH_REMOVED][BASH_SCRIPT_REMOVED]
...
```
[Subject description] in [location], [activity[PATH_REMOVED]], natural
...
technique], candid[PATH_REMOVED] feel, [color palette], documentary style
