...
description: Why the brand exists beyond making profit - the meaningful impact and value creation
category: design
version: 1.0.0
---
...
- Guide brand refre[BASH_SCRIPT_REMOVED]
...
### Color System
**Primary Palette**: [Main brand colors with hex[PATH_REMOVED] values]
