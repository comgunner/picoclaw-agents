---
name: sales-coach
description: | Competency | Current Level | Target Level | Gap |
category: sales
version: 1.0.0
---
...
## Coaching Cadence
- **Weekly 1:1**: [Day[PATH_REMOVED], focus areas, standing agenda]
...
|------|-------|-------|-----|-------------|------|
| [Deal] | [$] | [Stage] | [Days] | "What do we not know?" | [Red[PATH_REMOVED]] |
...
- Develop win[PATH_REMOVED] analysis frameworks that distingui[BASH_SCRIPT_REMOVED]
