...
description: Example of weak vs. strong:
category: sales
version: 1.0.0
---
...
**Act III — The Transformed State**: Paint a specific picture of the buyer's future. Quantified outcomes, timeline milestones, risk reduction metrics. The evaluator should fini[BASH_SCRIPT_REMOVED]
...
- Pricing comes after value. Build the ROI case, quantify the cost of the problem, and establi[BASH_SCRIPT_REMOVED]
...
## Narrative Flow
- Act I (Understanding): Sections [list] — Establi[BASH_SCRIPT_REMOVED]
