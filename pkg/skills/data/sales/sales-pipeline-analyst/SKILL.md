...
description: Each variable is a diagnostic lever:
category: sales
version: 1.0.0
---
...
|-------------------------|------------|-------------|-------|-----------|
| Pipeline Velocity       | $[X][PATH_REMOVED]   | $[Y][PATH_REMOVED]    | [+[PATH_REMOVED]] | $[Z][PATH_REMOVED]  |
| Qualified Opportunities | [N]        | [N]         | [+[PATH_REMOVED]] | [N]       |
| Average Deal Size       | $[X]       | $[Y]        | [+[PATH_REMOVED]] | $[Z]      |
| Win Rate (overall)      | [X]%       | [Y]%        | [+[PATH_REMOVED]] | [Z]%      |
| Sales Cycle Length       | [X] days   | [Y] days    | [+[PATH_REMOVED]] | [Z] days  |
...
|-----------|-------|-------------|----------------|-------------|-------------------|
| [Deal A]  | [X]   | [N]         | [N][PATH_REMOVED]          | [Signal]    | [Action]          |
| [Deal B]  | [X]   | [N]         | [N][PATH_REMOVED]          | [Signal]    | [Action]          |
```
...
|---------------------------|-----------------|---------------------|
| Stage-Weighted (CRM)      | $[X]            | [+[PATH_REMOVED]]$[Y]           |
| Velocity-Adjusted         | $[X]            | [+[PATH_REMOVED]]$[Y]           |
| Engagement-Adjusted       | $[X]            | [+[PATH_REMOVED]]$[Y]           |
| Historical Pattern Match  | $[X]            | [+[PATH_REMOVED]]$[Y]           |
...
|------------------|-------------|-------|----------------------------------------|
| Metrics          | [G[PATH_REMOVED]]     | [0-2] | [What's known or missing]              |
| Economic Buyer   | [G[PATH_REMOVED]]     | [0-2] | [Identified? Engaged? Accessible?]     |
| Decision Criteria| [G[PATH_REMOVED]]     | [0-2] | [Known? Favorable? Confirmed?]         |
| Decision Process | [G[PATH_REMOVED]]     | [0-2] | [Mapped? Timeline confirmed?]          |
| Paper Process    | [G[PATH_REMOVED]]     | [0-2] | [Legal[PATH_REMOVED] mapped?]   |
| Implicated Pain  | [G[PATH_REMOVED]]     | [0-2] | [Business outcome tied to pain?]       |
| Champion         | [G[PATH_REMOVED]]     | [0-2] | [Identified? Tested? Active?]          |
| Competition      | [G[PATH_REMOVED]]     | [0-2] | [Known? Position assessed?]            |

**Qualification Score**: [N][PATH_REMOVED]
**Engagement Score**: [N][PATH_REMOVED] (based on recency, breadth, buyer-initiated activity)
**Velocity Score**: [N][PATH_REMOVED] (based on stage progression vs. benchmark)
**Composite Deal Health**: [N][PATH_REMOVED]
...
- Win[PATH_REMOVED] pattern analysis by rep to identify specific skill development opportunities with measurable baselines
