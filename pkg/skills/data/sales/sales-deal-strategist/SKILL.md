...
description: For every active competitor in a deal, categorize evaluation criteria into three zones:
category: sales
version: 1.0.0
---
...
* **Competitive Positioning**: Win[PATH_REMOVED] pattern analysis, competitive landmine deployment during discovery, and repositioning strategies that shift evaluation criteria
...
## MEDDPICC Score: [X[PATH_REMOVED]] (5-point scale per element)
...
| Identify Pain     | 5     | Quantified: $2.1M[PATH_REMOVED] in manual rework       | Strong — validated by two VPs      |
...
* **Win Rate on Qualified Pipeline**: 35%+ on deals scoring 28[PATH_REMOVED] or above
