...
description: FIRMOGRAPHIC FILTERS
category: sales
version: 1.0.0
---
...
- Direct intent: G2[PATH_REMOVED] site visits, pricing page views, competitor comparison searches
...
- Full account research: 10-K[PATH_REMOVED] reports, earnings calls, strategic initiatives
...
| Technical buyers | Email (technical content) | Community[PATH_REMOVED] | LinkedIn |
...
Touch 3 (Day 5, Email): Share relevant insight[PATH_REMOVED] point tied to their situation
...
Touch 6 (Day 14, Email): Case study from similar company[PATH_REMOVED] + clear CTA
...
- Role[PATH_REMOVED] personalized: 5-8% reply rate
...
The SDR role is shifting from volume operator to revenue specialist. The old model — 100 activities[PATH_REMOVED], rigid scripts, hand off any meeting that sticks — is dying. The new model:
