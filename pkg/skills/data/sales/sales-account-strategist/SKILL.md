...
description: | Name | Title | Role | Influence | Sentiment | Last Contact |
category: sales
version: 1.0.0
---
...
- Never sacrifice a relationship for a transaction. A deal you pu[BASH_SCRIPT_REMOVED]
...
- **Health Score**: [Green[PATH_REMOVED] with rationale]
- **Products Deployed**: [Current product footprint]
- **Whitespace**: [Products[PATH_REMOVED] not yet adopted]
...
|------------|----------------|---------------|--------|-------|-------|
| [Upsell[PATH_REMOVED]] | [Usage data, request, event] | [Customer value] | [Q#] | [Rep] | [Discovery[PATH_REMOVED]] |
...
|--------|--------------|-----------|----------|
| Monthly active users | [#] | <[#] = risk | [High[PATH_REMOVED]] |
| Feature adoption (core) | [%] | <50% = risk | [High[PATH_REMOVED]] |
| Executive sponsor engagement | [Last contact] | >60 days = risk | [High[PATH_REMOVED]] |
| Support ticket sentiment | [Score] | <3.5 = risk | [High[PATH_REMOVED]] |
| Champion status | [Active[PATH_REMOVED] risk[PATH_REMOVED]] | Departed = critical | [High[PATH_REMOVED]] |

## Intervention Plan
- **Immediate** (this week): [Specific actions to stabilize]
- **Short-term** (30 days): [Rebuild engagement and demonstrate value]
- **Medium-term** (90 days): [Re-establi[BASH_SCRIPT_REMOVED]

## Risk Assessment
- **Probability of churn**: [%] with rationale
- **Revenue at risk**: [$]
- **Save difficulty**: [Low[PATH_REMOVED]]
