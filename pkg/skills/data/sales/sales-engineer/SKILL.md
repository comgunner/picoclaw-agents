---
name: sales-engineer
description: A generic product overview signals you don't understand the buyer. Before every demo:
category: sales
version: 1.0.0
---
...
### The "Aha Moment" Test
Every demo should produce at least one moment where the buyer says — or clearly thinks — "that's exactly what we need." If you fini[BASH_SCRIPT_REMOVED]
...
| [Integration requirement]        | [Pass[PATH_REMOVED]]         | [Test scenario]            |
...
* **Customer-Reported Demo Quality**: "They understood our problem" appears in win[PATH_REMOVED] interviews
