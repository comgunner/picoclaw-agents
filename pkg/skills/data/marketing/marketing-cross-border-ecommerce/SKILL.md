...
description: | Metric | Evaluation Criteria | Data Source |
category: marketing
version: 1.0.0
---
...
- **Shopee (Southeast Asia / Latin America)**: Store design, platform campaign enrollment (9.9[PATH_REMOVED]), Shopee Ads, Chat conversion, free shipping campaigns
...
- **First-mile logistics**: Full container load / less-than-container load (FCL[PATH_REMOVED]) ocean freight, air freight / air express, rail (China-Europe Railway Express), customs clearance procedures
...
- **VAT (Value Added Tax)**: UK VAT registration and filing, EU IOSS[PATH_REMOVED] one-stop filing, German Packaging Act (VerpackG), EPR compliance
- **US Sales Tax**: State-by-state Sales Tax nexus rules, Economic Nexus determination, tax remittance services
- **Product certifications**: CE (EU), FCC (US), FDA (food[PATH_REMOVED]), PSE (Japan), WEEE (e-waste), CPC (children's products)
...
- **Amazon A+ Content**: Brand story modules, comparison charts, enhanced content design, A+ page A[PATH_REMOVED] testing
...
- **Amazon ad optimization**: Auto[PATH_REMOVED] campaign mix, negative keyword strategy, bid optimization, ACOS[PATH_REMOVED] control, attribution analysis
- **Shopee[PATH_REMOVED] Ads**: Keyword ads, association ads, platform promotion tool ROI optimization
- **Off-platform traffic**: Facebook Ads, Google Ads (Search + Shopping), Instagram[PATH_REMOVED] visual marketing, TikTok Ads
...
- **DTC independent sites**: Shopify / Shoplazza site building, theme design, payment gateways (Stripe[PATH_REMOVED]), logistics integration
- **Brand registry**: Amazon Brand Registry, Shopee Brand Portal, platform brand protection programs
- **International social media marketing**: Instagram[PATH_REMOVED] content strategy, KOL[PATH_REMOVED] partnerships, UGC campaigns
- **Brand site SEO**: Domain strategy, technical SEO, content marketing, backlink building
- **Email marketing**: Tool selection (Klaviyo[PATH_REMOVED]), email sequence design, abandoned cart recovery, repurchase activation
...
- **Platform return policies**: Amazon return policy (FBA auto-processing / FBM return address), Shopee return[PATH_REMOVED] flow, marketplace-specific post-sales differences
...
- **Shopee[PATH_REMOVED]**: Platform campaigns are the primary traffic source, but calculate actual profit for every campaign. Don't join at a loss just to chase GMV
...
- Product compliance is non-negotiable: never list products without required CE[PATH_REMOVED] certifications. Getting caught means delisting plus potential massive fines
- VAT[PATH_REMOVED] Tax must be filed properly; tax evasion is a ticking time bomb for cross-border sellers
...
- [ ] Is there patent[PATH_REMOVED] infringement risk?
...
- Obtain required product certifications for target markets (CE[PATH_REMOVED], etc.)
...
- Core metrics monitoring: sales volume, conversion rate, ACOS[PATH_REMOVED], margin, inventory turnover
