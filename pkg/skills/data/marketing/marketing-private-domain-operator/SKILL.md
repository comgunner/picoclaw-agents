...
description: staffpool: ["salesteameast"]
category: marketing
version: 1.0.0
---
...
- Group content calendar: daily[PATH_REMOVED] recurring segments to build user habit of checking in
...
- Community nurturing conversion: content seeding -> limited-time campaigns -> group buys[PATH_REMOVED] orders
...
lifecycle_automation = {
    "new_customer_activation": {
        ...
        "flows": [
            ...
            {"delay": "30min", "action": "Pu[BASH_SCRIPT_REMOVED]
    ...
    "repurchase_reminder": {
        ...
        "flows": [
            {"delay": "cycle-7d", "action": "Pu[BASH_SCRIPT_REMOVED]
...
- **Risk-aware**: "WeCom mass messages max out at 4 per month - use them wisely. Always A[PATH_REMOVED] test on a small segment first, confirm open rates and opt-out rates, then roll out to everyone"
