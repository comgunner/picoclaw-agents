...
description: Build sustainable organic search visibility through:
category: marketing
version: 1.0.0
---
...
- Link equity distribution score: X[PATH_REMOVED]
...
## Mobile Optimization
- Mobile-friendly status: [Pass[PATH_REMOVED]]
- Viewport configuration: [correct[PATH_REMOVED]]
- Touch target spacing: [compliant[PATH_REMOVED]]
- Font legibility: [adequate[PATH_REMOVED] improvement]
```
...
- **Keyword Difficulty**: XX[PATH_REMOVED]
- **Current Position**: XX (or not ranking)
- **Search Intent**: [Informational[PATH_REMOVED]]
- **SERP Features**: [Featured Snippet, PAA, Video, Images]
- **Target URL**: [PATH_REMOVED]

### Supporting Content Cluster
| Keyword | Volume | KD | Intent | Target URL | Priority |
|---------|--------|----|--------|------------|----------|
| [long-tail 1] | X,XXX | XX | Info | [PATH_REMOVED] | High |
| [long-tail 2] | X,XXX | XX | Commercial | [PATH_REMOVED] | Medium |
| [long-tail 3] | XXX | XX | Transactional | [PATH_REMOVED] | High |
...
- [ ] Hreflang tags: [if multilingual — specify language[PATH_REMOVED] mappings]
...
- [ ] Internal links: [X] contextual links to related pillar[PATH_REMOVED] content
- [ ] External links: [X] citations to authoritative sources (E-E-A-T signal)

## Media & Engagement
- [ ] Images: Descriptive alt text, compressed (<100KB), WebP[PATH_REMOVED] format
- [ ] Video: Embedded with schema markup where relevant
- [ ] Tables[PATH_REMOVED]: Structured for featured snippet capture
- [ ] FAQ section: Targeting People Also Ask questions with concise answers

## Schema Markup
- [ ] Primary schema type: [Article[PATH_REMOVED]]
...
- Domain Rating[PATH_REMOVED]: XX
- Referring Domains: X,XXX
- Backlink quality distribution: [High[PATH_REMOVED] percentages]
...
- Expert commentary and trend analysis → HARO[PATH_REMOVED] responses
...
| Source Type | Target Links[PATH_REMOVED] | Avg DR | Approach |
|-------------|-------------------|--------|----------|
...
4. **Content Calendar**: Prioritize content creation[PATH_REMOVED] by impact potential (volume × achievability)
...
2. **Digital PR Campaigns**: Create linkable assets and execute journalist[PATH_REMOVED] outreach
...
- **Technical Baseline Retention**: Remember site architecture, CMS constraints, and resolved[PATH_REMOVED] technical debt
...
- **Domain Authority Growth**: Steady month-over-month increase in domain rating[PATH_REMOVED]
