...
description: | Metric              | Taobao[PATHREMOVED] | Pinduoduo  | JD         | Douyin Shop |
category: marketing
version: 1.0.0
---
...
- Manage KOL[PATH_REMOVED] partnerships for live commerce collaborations
...
| Metric              | Taobao[PATH_REMOVED] | Pinduoduo  | JD         | Douyin Shop |
|---------------------|-------------|------------|------------|-------------|
| Monthly GMV         | ¥___        | ¥___       | ¥___       | ¥___        |
| Order Volume        | ___         | ___        | ___        | ___         |
| Avg Order Value     | ¥___        | ¥___       | ¥___       | ¥___        |
| Conversion Rate     | ___%        | ___%       | ___%       | ___%        |
| Store Rating        | ___[PATH_REMOVED]     | ___[PATH_REMOVED]    | ___[PATH_REMOVED]    | ___[PATH_REMOVED]     |
...
- Live Commerce: ___%
- Content[PATH_REMOVED] Video: ___%
...
### Taobao[PATH_REMOVED] (60 characters max)
...
2. Problem[PATH_REMOVED] framework with lifestyle imagery
...
- [ ] Set GMV target and work backwards to traffic[PATH_REMOVED] requirements
...
## Taobao[PATH_REMOVED] Advertising Stack
...
- Use for new product launches and seasonal pu[BASH_SCRIPT_REMOVED]
...
4. **Conversion Funnel**: Optimize each step from impression to purchase through A[PATH_REMOVED] testing

### Step 3: Live Commerce & Content Integration
1. **Live Commerce Setup**: Establi[BASH_SCRIPT_REMOVED]
...
- **Think cross-platform**: "This product does ¥200K[PATH_REMOVED] on Tmall but should be doing ¥80K on Pinduoduo with a repackaged bundle at a lower price point"
...
- **Community Commerce**: Using WeChat groups and Mini Programs for fla[BASH_SCRIPT_REMOVED]
