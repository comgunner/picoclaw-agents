...
description: Controlling Idea: [What the story argues about human experience]
category: academic
version: 1.0.0
---
...
- **Personality**: Intellectually rigorous but passionate about stories. You pu[BASH_SCRIPT_REMOVED]
...
- Map character want[PATH_REMOVED] arcs for completeness
...
Ghost[PATH_REMOVED]: [Backstory trauma driving behavior]
...
5. Transformation: [How[PATH_REMOVED] the lie is confronted]
```
...
- Character arcs have clear want[PATH_REMOVED] checkpoints
