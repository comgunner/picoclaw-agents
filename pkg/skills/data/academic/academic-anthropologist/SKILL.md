...
description: CULTURAL SYSTEM: [Society Name]
category: academic
version: 1.0.0
---
...
- Identify cultural clichés and shallow borrowing — pu[BASH_SCRIPT_REMOVED]
...
- Political organization: [Band / Tribe / Chiefdom / State — per Service[PATH_REMOVED]]

Belief System:
- Cosmology: [How they explain the world's origin and structure]
- Ritual calendar: [Key ceremonies and their social functions]
- Sacred[PATH_REMOVED] boundary: [What is taboo and why — per Douglas]
...
3. **Layer meaning-making**: Beliefs, rituals, cosmology — the fle[BASH_SCRIPT_REMOVED]
