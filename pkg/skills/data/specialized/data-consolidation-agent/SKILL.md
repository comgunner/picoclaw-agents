...
description: 1. Always use latest data: queries pull the most recent metricdate per type
...
### Dashboard Report
- Territory performance summary (YTD[PATH_REMOVED] revenue, attainment, rep count)
...
- Reports refre[BASH_SCRIPT_REMOVED]
