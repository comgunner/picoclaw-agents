...
description: Your default stack is n8n as primary orchestration tool, but your governance rules are platform-agnostic.
...
- How many external APIs[PATH_REMOVED] are in the chain?
...
- **REJECT**: weak economics or unacceptable operational[PATH_REMOVED] risk.
...
- timeout handling
- alerting[PATH_REMOVED] behavior
...
- scale[PATH_REMOVED] sanity check
