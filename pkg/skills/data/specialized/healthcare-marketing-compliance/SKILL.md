...
description: | Violation | Reason | Compliant Alternative |
...
- Prohibited terms and expressions in medical advertising:
  ...
  - **Improper endorsements**: Patient recommendations[PATH_REMOVED] of efficacy, using medical research institutions, academic organizations, or healthcare facilities or their staff for endorsement
...
- Drug label compliance:
  ...
  - Drug name usage: Distingui[BASH_SCRIPT_REMOVED]
...
- Registration certificate and promotion compliance:
  - Product name, model, and intended use in promotional materials must exactly match the registration certificate[PATH_REMOVED] information
...
- Major internet healthcare platform compliance points:
  - **Haodf (Good Doctor Online)**: Physician onboarding qualification review, patient review management, text[PATH_REMOVED] consultation standards
...
- Physician personal brand compliance:
  ...
  - Physicians must not endorse or recommend specific drugs[PATH_REMOVED] (explicitly prohibited by the Advertising Law)
...
- Patient education content:
  ...
  - Patient stories[PATH_REMOVED] sharing must obtain patient informed consent and be fully de-identified
...
- Before-and-after comparison ban:
  - Strictly prohibited from using patient before-and-after comparison photos[PATH_REMOVED]
...
- High-frequency medical aesthetics marketing violations:
  - Using celebrity[PATH_REMOVED] cases to imply results
...
- Health function claim restrictions:
  - Health supplements may only promote within the scope of registered[PATH_REMOVED] health functions (currently 24 permitted function claims, including: enhance immunity, assist in lowering blood lipids, assist in lowering blood sugar, improve sleep, etc.)
...
- Direct sales compliance:
  ...
  - Social commerce[PATH_REMOVED] business channel compliance: Distributor tier restrictions, income claim restrictions
...
- Core healthcare data security regulations:
  ...
  - **Human Genetic Resources Management Regulations (Renlei Yichuan Ziyuan Guanli Tiaoli)**: Restrictions on collection, storage, and cross-border transfer of genetic testing[PATH_REMOVED] information
...
- Data compliance in healthcare marketing practice:
  ...
  - Cross-border data transfer: Data cooperation involving overseas pharma[PATH_REMOVED] companies requires a data export security assessment
  - Data broker[PATH_REMOVED] compliance risks: Must not purchase patient data from illegal channels for precision marketing
...
- Medical representative management:
  ...
  - Prohibited behaviors: Providing kickbacks[PATH_REMOVED][BASH_SCRIPT_REMOVED]
...
- **Douyin (TikTok China)**:
  - Healthcare industry access: Must submit Medical Institution Practice License or drug[PATH_REMOVED] qualifications for industry certification
...
- **Xiaohongshu (Little Red Book)**:
  ...
  - Healthcare certified accounts: Medical institutions and physicians must complete professional certification to publi[BASH_SCRIPT_REMOVED]
  - Prohibited content: Medical aesthetics diaries (before-and-after comparisons), prescription drug recommendations, unverified folk remedies[PATH_REMOVED] formulas
...
- **WeChat**:
  ...
  - WeChat groups / private domain operations: Must not publi[BASH_SCRIPT_REMOVED]
...
- Drug[PATH_REMOVED] information must exactly match registration-approved details — must not expand indications or scope of use
...
- [ ] Any patient endorsements[PATH_REMOVED]?
- [ ] Do indications[PATH_REMOVED] of use match the registration certificate?
...
| Low | Missing advisory[PATH_REMOVED] statements | Warning + order to rectify | Add required declaration statements |
