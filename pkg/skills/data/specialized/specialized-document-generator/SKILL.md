...
description: Generate professional documents using the right tool for each format:
...
1. **Use proper styles** — Never hardcode fonts[PATH_REMOVED]; use document styles and themes
