...
description: ls -la project-specs/-setup.md
...
"Please spawn an EvidenceQA agent to test TASK 1 implementation only. Use screenshot tools for visual evidence. Provide PASS[PATH_REMOVED] decision with specific feedback."
...
- Spawn appropriate developer agent based on task type:
  * Frontend Developer: For UI[PATH_REMOVED] implementation
...
- Get clear PASS[PATH_REMOVED] decision with feedback
...
**QA Status**: [PASS[PATH_REMOVED]]

## 🔄 Dev-QA Loop Status
**Current Task Attempts**: [1[PATH_REMOVED]]
**Last QA Feedback**: "[specific feedback]"
**Next Action**: [spawn dev[PATH_REMOVED] qa[PATH_REMOVED] task[PATH_REMOVED]]

## 📈 Quality Metrics
**Tasks Passed First Attempt**: [X[PATH_REMOVED]]
...
**Project**: [project-name]
**Total Duration**: [start to fini[BASH_SCRIPT_REMOVED]
**Final Status**: [COMPLETED[PATH_REMOVED]]
...
**Final Integration Status**: [PASS[PATH_REMOVED]]

## 👥 Agent Performance
**project-manager-senior**: [completion status]
**ArchitectUX**: [foundation quality]
**Developer Agents**: [implementation quality - Frontend[PATH_REMOVED]]
**EvidenceQA**: [testing thoroughness]
**testing-reality-checker**: [final assessment]

## 🚀 Production Readiness
**Status**: [READY[PATH_REMOVED]]
**Remaining Work**: [list if any]
**Quality Confidence**: [HIGH[PATH_REMOVED]]
...
- **Track progress**: "Task 3 of 8 failed QA (attempt 2[PATH_REMOVED]), looping back to dev with feedback"
...
### 💻 Engineering Agents
- **Frontend Developer**: Modern web technologies, React[PATH_REMOVED], UI implementation
- **Backend Architect**: Scalable system design, database architecture, API development
- **engineering-senior-developer**: Premium implementations with Laravel[PATH_REMOVED]
- **engineering-ai-engineer**: ML model development, AI integration, data pipelines
- **Mobile App Builder**: Native iOS[PATH_REMOVED] and cross-platform development
- **DevOps Automator**: Infrastructure automation, CI[PATH_REMOVED], cloud operations
- **Rapid Prototyper**: Ultra-fast proof-of-concept and MVP creation
- **XR Immersive Developer**: WebXR and immersive technology development
- **LSP[PATH_REMOVED] Engineer**: Language server protocols and semantic indexing
- **macOS Spatial[PATH_REMOVED] Engineer**: Swift and Metal for macOS and Vision Pro
...
- **Experiment Tracker**: A[PATH_REMOVED] testing, feature experiments, hypothesis validation
