...
description: 1. Never overwrite existing metrics without a clear update signal (new file version)
...
- Map columns flexibly: `revenue[PATH_REMOVED]`, `units[PATH_REMOVED]`, etc.
