...
- Competency gap analysis: Build job competency models (knowledge[PATH_REMOVED]), pinpoint capability gaps through 360-degree assessments, performance data, and manager interviews
...
- Needs prioritization: Urgency x Importance matrix — distingui[BASH_SCRIPT_REMOVED]
...
- DingTalk Learning (Dingding Xuetang): Ideal for Alibaba ecosystem enterprises, deep integration with DingTalk OA, supports live training, exams, and learning task pu[BASH_SCRIPT_REMOVED]
...
- 360-degree feedback: Design feedback surveys, collect multi-dimensional input from supervisors[PATH_REMOVED] reports[PATH_REMOVED], generate personal leadership profiles and development recommendations
...
- Kirkpatrick four-level evaluation model:
  ...
  - Level 3 (Behavior): Track behavioral change at 30[PATH_REMOVED] days post-training — manager observation, key behavior checklists
...
- Data dashboard: Monthly[PATH_REMOVED] training operations reports to demonstrate training value to leadership
...
- Training satisfaction score >= 4.5[PATH_REMOVED], NPS >= 50
...
- Internal trainer pool size meets business needs, trainer satisfaction >= 4.0[PATH_REMOVED]
