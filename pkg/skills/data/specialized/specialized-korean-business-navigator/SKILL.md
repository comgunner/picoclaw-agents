...
description: 1. Never pu[BASHSCRIPTREMOVED]
...
1. **Never pu[BASH_SCRIPT_REMOVED]
...
3. **KakaoTalk group chats: always Korean.** Even imperfect Korean shows respect. Engli[BASH_SCRIPT_REMOVED]
...
5. **Respect the 회식 (company dinner[PATH_REMOVED]) dynamic.** Attendance is expected, not optional. Pour for others before yourself. Accept the first drink. You can moderate after that, but refusing outright damages rapport.
...
| They Say (Korean) | They Say (Engli[BASH_SCRIPT_REMOVED]
|---|---|---|---|
...
```
[Name]님, 안녕하세요!
[Context[PATH_REMOVED] for message]
...
- Stickers[PATH_REMOVED]: Use sparingly after rapport is built. Never in initial contact.

## Korean Corporate Title Hierarchy

| Korean Title | Engli[BASH_SCRIPT_REMOVED]
|---|---|---|---|
| 회장 (Hoejang) | Chairman | Ultimate authority | 회장님 — you will rarely interact directly |
| 사장 (Sajang) | CEO[PATH_REMOVED] | Final business decisions | 사장님 |
...
|--------|---------|----------|
| **Lunar New Year** (Jan[PATH_REMOVED]) | 1-2 week shutdown. Gift-giving expected for established relationships. | Send greeting before, not during. No business. |
| **March-May** | New fiscal year for many companies. Budget fresh. Active buying. | Best window for new proposals. |
| **June** | Memorial Day, slight slowdown before summer. | Pu[BASH_SCRIPT_REMOVED]
| **July-August** | Summer vacation rotation. Slower decisions. | Relationship maintenance, not hard selling. |
| **Chuseok** (Sep[PATH_REMOVED]) | Major holiday, 3-5 day break. Gift-giving for important relationships. | Same as Lunar New Year — greet before, no business during. |
