...
func TestListSkillsWorkspaceOverridesGlobal(t *testing.T) {
	...
	assert.Equal(t, "workspace", mySkill.Source)
	assert.Equal(t, "workspace version", mySkill.Description)
}
...
func TestListSkillsGlobalOverridesBuiltin(t *testing.T) {
	...
	assert.Equal(t, "global", mySkill.Source)
	assert.Equal(t, "global version", mySkill.Description)
}
...
func TestListSkillsMetadataNameDedup(t *testing.T) {
	...
	assert.Equal(t, "shared-name", sharedSkill.Name)
	assert.Equal(t, "workspace", sharedSkill.Source)
}
...
func TestListSkillsDirWithoutSkillMD(t *testing.T) {
	...
	assert.Equal(t, "real-skill", realSkill.Name)
}
