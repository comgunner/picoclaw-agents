    ...
    <CredentialCard
      title={
        <span className="inline-flex items-center gap-2">
          <span className="border-muted inline-flex size-6 items-center justify-center rounded-full border bg-[#615df1] text-white">
            <span className="text-[10px] font-bold leading-none">DS</span>
          </span>
          <span>DeepSeek</span>
        </span>
      }
      description="API key authentication for DeepSeek AI"
