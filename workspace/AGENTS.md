...
- Role: Gathers information via web search, evaluates sources, synthesizes findings, and produces structured reports.
- Use when: The task requires research, fact-checking, competitive analysis, or summarizing external information.

## Delegation Guidance
- Delegate execution-heavy tasks to `general_worker`.
- Delegate feature work to `senior_dev`.
- Delegate quick fixes to `junior_fixer`.
- Delegate research and information gathering to `researcher`.
