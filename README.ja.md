...
2026-03-01 🎉 **AI イメージ生成 & コミュニティマネージャー**: ネイティブイメージ生成 (Gemini/Ideogram)、スクリプトからイメージへのワークフロー、対話型生成後メニュー、およびソーシャルメディア投稿を自動生成するコミュニティマネージャーエージェントを追加。完全な設定と使用例は [docs/IMAGE_GEN_util.md](docs/IMAGE_GEN_util.md) を参照。
